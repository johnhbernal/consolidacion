			...
			case 'POST' :
				{
					...
					return [ 
							...
							'PRIMER_NOMBRE' => 'required|min:2|max:191|Alpha',
							'SEGUNDO_NOMBRE' => 'min:2|max:191|Alpha',
							'PRIMER_APELLIDO' => 'required|min:2|max:191|Alpha',
							'SEGUNDO_APELLIDO' => 'min:2|max:191|Alpha',
							'FECHA_DE_NACIMIENTO' => 'required|date',
// 					        'FECHA_DE_NACIMIENTO' => 'date_format:"YYYY-MM-DD"|required',
							'ESTADO' => 'required',
							'SEXO' => 'required',
